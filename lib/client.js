 ...
 *    未勾选技能，关=回到无本插件的默认工作流；抽屉与 better-sidebar 页签
 *    共用同一开关；状态经 `set-guard` 持久化到宿主 domain；
...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    /** 守卫开关（面板标题栏 "Skills/Auto-start" 页签旁，抽屉与 better-sidebar 页签共用）：开=拦截未勾选技能，关=默认工作流。 */
